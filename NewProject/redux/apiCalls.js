...
export const login = async (dispatch, user) => {
    ...
    try {
        dispatch(loginStart());
        const res = await axios.post("http://192.168.1.10:5000/sql/login", {email:user.email,password:user.password,phone:null});
        let obj={
            load:false,
            data:res.data
        }
...
export const loginAuth = async (dispatch, user) => {
    ...
    try {
        //dispatch(loginStart());
        const res=await axios.post('http://192.168.1.10:5000/sql/loginWithAuth',user[1])
...
export const register = async (dispatch, user) => {
    try {
        ...
        const res = await axios.post("http://192.168.1.10:5000/sql/register", { username:user.username, email:user.email, password:user.password, first_name:user.first_name, last_name:user.last_name,phone:null });
        let obj={
            load:false,
            data:res.data
        }
